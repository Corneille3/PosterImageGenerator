      ...
      <section className="mt-14">
        ...
        <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <div
              key={f.title}
              className="relative rounded-2xl border border-border bg-surface/60 p-6 text-center shadow-soft transition-transform duration-300 hover:scale-105 hover:bg-surface2/60"
            >
